...
<html>
  ...
  <body id="page-top">
      ...
      <div id="flipkart-navbar">
          <div class="container">
              <div class="row row1">
                <div class="col-sm-12">
                  <ul class="largenav flipkart-menu-ul">
                      ...
                      <li class="upper-links"><a class="links" href="#"> <i class="fas fa-random"></i> Recette alÃ©atoire</a></li>
                      ...
                      <%	if(u != null){ %>
				        ...
				        <li class="upper-links"><a class="links" href="/supCooking/logout"><i class="fas fa-users"></i> Déconnection</a></li>
				        <%} else {  %>
              ...
              <div class="row row2 d-flex align-items-center">
                  <div class="col-sm-3">
                      <h2 style="margin:0px;"><span class="smallnav menu" onclick="openNav()">â° <img class="img-fluid" src="assets/image/logo.png"></span></h2>
      ...
      <div id="mySidenav" class="sidenav">
          ...
          <a href="http://clashhacks.in/">AlÃ©atoire</a>
          <a href="#">Ma recette</a>
      ...
      <div class="dad">
        <div class="row" style="margin: 60px 0; text-align: center;">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h1 class="full-title">âLa bonne cuisine est honnÃªte, sincÃ¨re et simple.â</h1>
          </div>
        </div>
        <div class="row" style="margin: 60px 0; text-align: center;">
          ...
          <div class="container text-wrapper">
            ...
            <div class="row">
              <div class="col-lg-4 text-justify ml-auto">
                <p class="lead"><i>PrÃ©parer soi-mÃªme les repas demande un peu plus de temps que d'ouvrir un plat cuisinÃ© achetÃ© Ã  l'Ã©picerie.
                  Mais cuisiner est un plaisir, et c'est sans doute une des meilleures maniÃ¨re de transmettre notre amour aux gens qui nous entourent. 
                  C'est aussi un moyen de transmettre son savoir-faire !</i></p>
              </div>
              <div class="col-lg-4 text-justify mr-auto">
                <p class="lead"><i>C'est ici que nous intervenons, G2Oeufs Ã  Ã©tÃ© pensÃ© pour vous permettre de partager vos recettes, votre envie de la bonne cuisine et aider votre prochain.
                  <br> Que vous 
                  soyez un petit cuisinier ou un chef renommÃ© tout le monde peut partager son envie de la bonne cuisine.</i> </p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="bg-secondary">       
          <div class="title-arch"><h2>Notre sÃ©lÃ©ction de recettes de la semaine</h2></div>
          ...
          style="background-image: url('assets/image/gratin1.jpg');">
                <div class="project-hover">
                  <h3>Gratin Dauphinois</h3>
                    ...
                    <hr />
                    <p> La recette de vrai gratin Dauphinois, tel qu'il Ã©tait prÃ©parÃ©e par nos grand-mÃ¨res. Un plat Ã©conomique, facile, plutÃ´t rapide (demande peu de prÃ©paration), et dont tout le monde raffole..</p>
          ...
          style="background-image: url('assets/image/pizza1.jpg');">
              <div class="project-hover">
                  <h3>Pizza Jambon Fromage</h3>
                    <hr />
                    <p>Pour passer une bonne soirÃ©e avec vos amis, pensez aux classiques, comme la pizza jambon fromage. DÃ©couvrez la recette sans plus attendre.</p>
                    <a href="#">Voir la recette</a>
                </div>
            </div>
          ...
          style="background-image: url('assets/image/salade1.jpg');">
              <div class="project-hover">
                  <h3>Salade de concombre au chÃ¨vre et olives</h3>
                    <hr />
                    <p>Cet salade composÃ© avec ses ingrÃ©dients frais et variÃ© ravivra les papilles des plus gourmants ! Un plat rapide Ã  prÃ©parer et dÃ©licieux.</p>
                    <a href="#">Voir la recette</a>
                </div>
            </div>
          ...
          style="background-image: url(assets/image/pates1.jpg);">
            <div class="project-hover">
                <h3>PÃ¢tes sauce MadÃ¨re</h3>
                  <hr />
                  <p>Une sauce se mariant parfaitement avec quelques pÃ¢tes ou les viande rouges!</p>
                  <a href="#">Voir la recette</a>
            </div>
          </div>
